...
# <h3>  What are the ways to integrate Jenkins with GIT ?
# <h3>  What are the ways to integrate Jenkins with Jira ?
	
# <h3>  How would you copy files from one server to another in jenkins?
	
# <h3>  Jenkins Shared Library folder structure?
# <h3>  How to copy files in resources to Workspace?
# <h3>  Is it possible to have shared library in local instead of git repo? If yes how do you configure?
	
# <h3>  How do you automate job creation in jenkins?
	
# <h3>  After a pipeline job executes, Is it possible to automate trigger of jenkins freestyle job? Or is it possible to call freestyle from pipeline job?
# <h3>  (Trigger parameterized build on other projects)
	
# <h3>  For a new project implementaion how would you choose which pipeline to go with - Declarative and Scripted Pipeline?
